...
<body>
    <div class="bg-dark py-3">
        <h3 class="text-white text-center">Edit Project for User <?php echo e($user->id); ?></h3>
    </div>
    <div class="container">
        <div class="row d-flex justify-content-center mt-4">
            <div class="col-md-10 d-flex justify-content-end">
                <a href="<?php echo e(route('projects.list', $user->id)); ?> " class="btn btn-dark">Back</a>
            </div>
            <div class="col-md-10">
                <div class="card my-4">
                    ...
                    <form action="<?php echo e(route('projects.update',[$user->id,$project->id] )); ?>" method="post">
...
<?php /**PATH D:\laravel\resources\views\projects\editPro.blade.php ENDPATH**/ ?>