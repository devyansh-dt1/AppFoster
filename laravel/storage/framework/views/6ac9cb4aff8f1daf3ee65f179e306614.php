                    ...
                    <form action="<?php echo e(route('users.update', $user->id)); ?>" method="post">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input value="<?php echo e(old('name','$user->name')); ?>" type="text"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input value="<?php echo e(old('username','$user->username')); ?>" type="text"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input value="<?php echo e(old('phone','$user->phone')); ?>" type="text"
                                    class="form-control form-control-lg" placeholder="Enter your No." name="phone">
                            </div>
                            <div class="mb-3">
                                <label class="h5">E-mail</label>
                                <input value="<?php echo e(old('email','$user->email')); ?>" type="email"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input value="<?php echo e(old('website','$user->website')); ?>" type="text"
                                    class="form-control form-control-lg" placeholder="Enter your Website"
                                    name="website">
                            </div>
                            <div class="mb-3">
                                <label for="" class="h5">Company Name</label>
                                <input value="<?php echo e(old('companyname','$user->companyname')); ?>" type="text"
...
<?php /**PATH D:\laravel\resources\views\users\edit.blade.php ENDPATH**/ ?>